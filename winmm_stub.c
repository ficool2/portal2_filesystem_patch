/* modified from https://github.com/bangstk/ogg-winmm */
...
MMRESULT WINAPI fake_auxGetVolume(UINT a0, LPDWORD a1)
{
    static LRESULT(WINAPI * funcp)(UINT, LPDWORD) = NULL;
    if (funcp == NULL)
        funcp = (void*)GetProcAddress(loadRealDLL(), "auxGetVolume");
    return (*funcp)(a0, a1);
}

MMRESULT WINAPI fake_auxSetVolume(UINT a0, DWORD a1)
{
    static MMRESULT(WINAPI * funcp)(UINT, DWORD) = NULL;
    if (funcp == NULL)
        funcp = (void*)GetProcAddress(loadRealDLL(), "auxSetVolume");
    return (*funcp)(a0, a1);
}

MCIERROR WINAPI fake_mciSendCommandA(MCIDEVICEID a0, UINT a1, DWORD_PTR a2, DWORD_PTR a3)
{
    static MCIERROR(WINAPI * funcp)(MCIDEVICEID, UINT, DWORD_PTR, DWORD_PTR) = NULL;
    if (funcp == NULL)
        funcp = (void*)GetProcAddress(loadRealDLL(), "mciSendCommandA");
    return (*funcp)(a0, a1, a2, a3);
}

MCIERROR WINAPI fake_mciSendStringA(LPCTSTR a0, LPTSTR a1, UINT a2, HANDLE a3)
{
    static MCIERROR(WINAPI * funcp)(LPCTSTR, LPTSTR, UINT, HANDLE) = NULL;
    if (funcp == NULL)
        funcp = (void*)GetProcAddress(loadRealDLL(), "mciSendStringA");
    return (*funcp)(a0, a1, a2, a3);
}

MMRESULT WINAPI fake_auxGetDevCapsA(UINT_PTR a0, LPAUXCAPS a1, UINT a2)
{
    static MMRESULT(WINAPI * funcp)(UINT_PTR, LPAUXCAPS, UINT) = NULL;
    if (funcp == NULL)
...
{
    static UINT(WINAPI * funcp)(void) = NULL;
    if (funcp == NULL)
